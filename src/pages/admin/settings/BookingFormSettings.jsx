...
import { 
  ...
  Layers, Link2, AlertCircle, CheckCircle2, AlertTriangle, Users
} from 'lucide-react';
import HelpTooltip from '../../../components/ui/HelpTooltip';

// 🚀 SettingsPreviewLayout から reloadPreview を受け取る
const BookingFormSettings = ({ reloadPreview }) => {
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, padding: '24px', background: 'rgba(255,255,255,0.9)', backdropFilter: 'blur(10px)', borderTop: '1px solid #e2e8f0', zIndex: 1000 }}>
        <button onClick={handleSaveBasic} style={{ width: '100%', maxWidth: '500px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', padding: '18px', background: themeColor, color: '#fff', border: 'none', borderRadius: '50px', fontWeight: 'bold', fontSize: '1.1rem', boxShadow: `0 10px 25px ${themeColor}66`, cursor: 'pointer' }}>
          <Save size={22} /> フォーム設定を保存 💾
        </button>
      </div>
